...
C     Closed Form Mooney Rivlin Material Model
C       C10 = 0.1
C       C01 = 0.500
C       C20 = 0.0
...
C       ui1 = 0.0
C       ui2 = 0.0
C       ui1(1) = C10 + 2*C20*(I1-3) + 1.e-5
C       ui1(2) = C01

C       ui2(indx(1,1)) = 2*C20
...
C     Debugging
      if (noel.eq.500) then
        ...
        print*, 'First derivatives with MR'
     ...
     *          Psivw, Psiww
        print*, 'Second derivatives with MR'
